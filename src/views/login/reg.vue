  ...
  export default {
    ...
    methods: {
      ...
      handleLogin() {
        ...
        handleReg() {
            this.$refs.loginForm.validate(valid => {
                if (valid) {
                    ...
                    reg(this.loginForm.name, this.loginForm.password ,this.loginForm.code,this.loginForm.confimpassword).then(response => {
        ...
        codes() {
            if (this.loginForm.name ==null ||this.loginForm.name =='' || !isvalidname(this.loginForm.name)) {
               alert('请输入正确的手机号');
            } else {
                codes(this.loginForm.name).then(response => {
alert('发送成功');
                }).catch(error => {
                    console.log(error)
                })
