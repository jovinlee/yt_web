    ...
    <div class="app-container">
        ...
        <div class="table-container">
            <el-table :data="list" border style="width: 950px;margin:0 auto;">
                ...
                <el-table-column prop="rechar" label="充值" width="300"></el-table-column>
                <el-table-column prop="name" label="消费" width="300"></el-table-column>
